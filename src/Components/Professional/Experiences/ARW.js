    ...
    return (
        <div className="content">
            ...
            <div className="tall-text-lines text-center-justify text-align-left article">
                ...
                <p>
                    After fixing the scope of the web client, I built site maps, wireframes, and mockups for the pages of the Anti Ransomware web client.
                    Moving forward, I went on to create the ember engine and develop the web client module of the Anti Ransomware.
                    Currently, working on the development of additional features for the product and collating data for future enhancements.
                </p>
            </div>
        </div>
    );
